...
% Select largest from just the accumulator
...
%Select largest Subtraction of half the energy of the symbols
...
%Select largest after the accumulators are divided by the number of samples
...
%Select largest after the normalized accumulators Subtract half the energy 
...
'Removing the energy of the symbols, there are ',    num2str(percent_errors_without_energy),'% errors in ', num2str(number), ' symbols.     ';
'Dividing by the samples, there are ', num2str(percent_errors_divide),'% errors in ',  num2str(number), ' symbols.                ';
