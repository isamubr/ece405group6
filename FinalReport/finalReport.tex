...
\lstinputlisting{code/FrameTest.M}

\lstset{caption={DataMessage recreates the string that was used as an input to data},label=DataMessage}
\lstinputlisting{code/DataMessage.M}

\lstset{caption={Receiver code to use the Team 4 physical layer. The explanation of how it works is in section \ref{team4_results} of this report},label=ReceiverTeam4Code}
\lstinputlisting{code/FrameObj.M}
